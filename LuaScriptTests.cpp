...
TEST_CASE_FIXTURE(LuaScriptTests, "Script.Lua.Overloads")
{
    ...
    SUBCASE("Member functions")
    {
        ...
        auto            f3 = static_cast<f32 (TestScriptClass::*)()>(&TestScriptClass::overload);
...
TEST_CASE_FIXTURE(LuaScriptTests, "Script.Lua.TcobTypes")
{
    ...
    SUBCASE("is")
    {
        ...
        auto ca = global["colorArr"].as<color>();
        REQUIRE(global.is<color>("colorArr"));
        REQUIRE(ca == color(5, 4, 3, 2));
